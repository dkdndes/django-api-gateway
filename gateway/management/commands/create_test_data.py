...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Created domain: {jsonplaceholder.name}'))
        else:
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Created endpoint: {create_post_endpoint}'))
        else:
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Created request transformation: {req_transform}'))
        else:
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Created response transformation: {resp_transform}'))
        else:
