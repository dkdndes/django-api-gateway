...
class Domain(models.Model):
    ...
    name = models.CharField(
        max_length=255, unique=True, help_text="Domain name (e.g., 'example.com')"
    )
    ...
    description = models.TextField(
        blank=True, null=True, help_text="Description of the domain"
    )
...
class ApiEndpoint(models.Model):
    ...
    path = models.CharField(
        max_length=255, help_text="Path of the endpoint (e.g., '/users')"
    )
...
class RequestTransformation(models.Model):
    ...
    source_field = models.CharField(
        max_length=255, help_text="Source field in the request"
    )
    target_field = models.CharField(
        max_length=255, help_text="Target field in the transformed request"
    )
    ...
    transformation_value = models.TextField(
        blank=True, null=True, help_text="Value or template for the transformation"
    )
    is_active = models.BooleanField(
...
class ResponseTransformation(models.Model):
    ...
    source_field = models.CharField(
        max_length=255, help_text="Source field in the response"
    )
    target_field = models.CharField(
        max_length=255, help_text="Target field in the transformed response"
    )
    transformation_type = models.CharField(
        max_length=50,
        default="direct",
...
class ApiLog(models.Model):
    ...
    request_method = models.CharField(
        max_length=10, help_text="HTTP method of the request"
    )
    request_path = models.CharField(max_length=255, help_text="Path of the request")
    request_headers = models.TextField(
        blank=True, null=True, help_text="Headers of the request"
    )
    request_body = models.TextField(
        blank=True, null=True, help_text="Body of the request"
    )
    response_status = models.IntegerField(help_text="Status code of the response")
    response_headers = models.TextField(
        blank=True, null=True, help_text="Headers of the response"
    )
    response_body = models.TextField(
        blank=True, null=True, help_text="Body of the response"
    )
