...
def test_create_test_data_command():
    ...
    assert ApiEndpoint.objects.filter(domain=catapi, path='/images/search', method='GET').exists()
    assert ApiEndpoint.objects.filter(domain=catapi, path='/images/search/with_apikey', method='GET').exists()
    assert ApiEndpoint.objects.filter(domain=catapi, path='/images/{id}', method='GET').exists()
    ...
    cat_images_endpoint = ApiEndpoint.objects.get(domain=catapi, path='/images/search', method='GET')
