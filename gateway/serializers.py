...
class RequestTransformationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'endpoint', 'source_field', 'target_field', 'transformation_type', 
                 'transformation_value', 'is_active', 'created_at', 'updated_at']
...
class ApiEndpointSerializer(serializers.ModelSerializer):
    ...
    response_transformations = ResponseTransformationSerializer(many=True, read_only=True)
    
    class Meta:
        model = ApiEndpoint
        fields = ['id', 'domain', 'path', 'method', 'target_url', 'timeout', 
                 'is_active', 'created_at', 'updated_at', 'request_transformations', 
...
class DomainSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Domain
        fields = ['id', 'name', 'base_url', 'description', 'is_active', 
                 'created_at', 'updated_at', 'endpoints']

class ApiLogSerializer(serializers.ModelSerializer):
    class Meta:
        model = ApiLog
        fields = ['id', 'endpoint', 'request_method', 'request_path', 
